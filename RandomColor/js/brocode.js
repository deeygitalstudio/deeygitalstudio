...
const ulEl = document.querySelector('.w3-ul');
...
const colorArray = ['w3-red', 'w3-green', 'w3-yellow', 'w3-orange', 'w3-deep-orange', 'w3-gray', 'w3-black', 'w3-pink', 'w3-yellow']

btnEl .addEventListener("click", function(){
    const random = Math.floor(Math.random() * colorArray.length);
    colorEl.className = colorArray[random];
